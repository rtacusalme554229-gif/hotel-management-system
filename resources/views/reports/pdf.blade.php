...
<head>
    <meta charset="utf-8">
    <title>StayEase Hotel - Premium Report</title>
...
<div class="report-wrapper">
    ...
    <!-- HEADER -->
    <div class="header">
        <div class="header-title">StayEase Hotel</div>
    ...
    <!-- FOOTER -->
    <div class="footer">
        Generated by StayEase Hotel Management System • Premium Operations Report
    </div>
